...
class Entry:
    def __init__(self, entry_db_lookup):
        ...
        self.patient_name = entry_db_lookup[4]
        self.scheduled_timestamp = entry_db_lookup[5]
        self.added_timestamp = entry_db_lookup[6]
        self.last_edited_timestamp = entry_db_lookup[7]
        self.type_of_surgery = entry_db_lookup[8]
        self.diagnosis = entry_db_lookup[9]
        self.patient_birth_year = entry_db_lookup[10]
        self.patient_phone_number = entry_db_lookup[11]
        self.has_consultation_happened = entry_db_lookup[12]
        self.is_completed = entry_db_lookup[13]
